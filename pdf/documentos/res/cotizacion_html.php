...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
		<td style="width:50%; "><strong>Dirección:</strong> <br>San Miguel, El Salvador C.A.<br> <strong>Teléfono.:</strong> (503)2222-2222</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
            ...
            <td style="width:15%; "><strong>Atención:</strong></td>
...
while ($row=mysqli_fetch_array($sql))
	...
	<table cellspacing="0" style="width: 100%; border: solid 1px black;  text-align: center; font-size: 11pt;padding:1mm;">
        <tr>
            ...
            <td style="width: 30%; text-align: left"><? echo $categoria;?></td>
	...
	$insert_detail = mysqli_query($con, "INSERT INTO detalle_cotizacion_demo VALUES ('','$numero_cotizacion','$id_repuesto','$cantidad','$precio_venta_r')");
	}

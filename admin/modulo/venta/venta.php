      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <h3><i class="fa fa-angle-right"></i> Punto de Venta | Cajero: <strong style="text-transform: capitalize;"><?php echo $_SESSION['nameUser']; ?></strong> <!-- | Caja: -->
...
<script type="text/javascript">
    $('#modal_prepara_venta').on('hidden.bs.modal', function (e) {
        // do something...
        $('#prepara_venta').get(0).reset();

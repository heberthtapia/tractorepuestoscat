			...
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nombre Repuesto" data-validation="required" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cantidad" class="control-label col-md-3">Cantidad en Stock Actual:</label>
                        <div class="col-md-4 col-xs-6">
                            <input type="text" class="form-control" id="cantidadActual" name="cantidadActual" placeholder="Cantidad en Stock Actual" data-validation="required number" disabled >
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <input type="text" class="form-control" id="cantidad" name="cantidad" onblur="javascript:cant_StockAsig()" placeholder="Cantidad a Agregar" data-validation="required number" >
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <input type="text" class="form-control" id="cantStock" onblur="javascript:cant_StockAsig()" name="cantStock" placeholder="Cantidad para Asignar" data-validation="number" data-validation-allowing="range[0;0]" data-validation-error-msg="Se debe de asignar todo el STOCK" value="0">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">

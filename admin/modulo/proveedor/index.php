      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <h1 class="avisos" align="center"><strong>PROVEEDORES</strong></h1>
          	<h3><i class="fa fa-angle-right"></i> Lista de Proveedores</h3>
        <div class="row mt">
          <div class="col-lg-12">
...
<?PHP
include 'newProveedor.php';
include 'editProveedor.php';
include 'previewProveedor.php';
include 'delProveedor.php';
?>
  </body>
</html>

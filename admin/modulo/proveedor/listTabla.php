                ...
                <tr id="tb<?=$row[0]?>">
                    ...
                    <td width="15%">
                        ...
                        <div style="width: 188px; margin-top: 5px">
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#dataDeleteCli" data-id="<?=$row['id_proveedor']?>"  ><i class='glyphicon glyphicon-trash'></i> Eliminar
                            </button>

...
$asunto = $data->asunto;//"Mensaje es de prueba";
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
      <tr align="center">
        <td bgcolor="#efefef" class="header" height="70" style="padding: 0 20px 20px 0;">
          ...
          <img class="fix" src="http://www.tractorepuestoscat.com/demo/img/logo.jpg" height="70" border="0" alt="" />
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" class="footercopy">
                &reg; Tractorepuestos CAT 2017<br/>
                  ...
                  <tr>
                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                      <a href="http://www.facebook.com/">
                        <img src="http://www.tractorepuestoscat.com/demo/images/facebook.png" width="37" height="37" alt="Facebook" border="0" />
                      </a>
                    </td>
                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                      <a href="http://www.twitter.com/">
                        <img src="http://www.tractorepuestoscat.com/demo/images/twitter.png" width="37" height="37" alt="Twitter" border="0" />
                      </a>
                    </td>
                  </tr>
                </table>
...
$destinatario1 = "soporte@tractorepuestoscat.com";
...
$headers .= "Return-path: soporte@tractorepuestoscat.com\r\n";
